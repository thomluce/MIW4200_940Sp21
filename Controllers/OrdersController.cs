...
namespace MIW4200_940.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ordersID,description,orderDate,customerID")] Orders orders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ordersID,description,orderDate,customerID")] Orders orders)
        {
            if (ModelState.IsValid)
            {
